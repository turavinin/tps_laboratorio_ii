...
namespace TP3
{
    public partial class FormPersona : Form
    {
        ...
        private void btnEliminarPersona_Click(object sender, EventArgs e)
        {
            ...
            {
                var persona = _encuestaManager.EncontrarRegistroLista<Persona>(id);
                _encuestaManager.EliminarRegistroLista(persona);
                _encuestaManager.EliminarEntidad<Persona>(id);
                this.ActualizarListaPersonas(_encuestaManager.Personas);
            }
        }
